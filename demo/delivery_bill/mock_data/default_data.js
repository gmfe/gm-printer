...
export default {
  ...
  details: [
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 144.0,
      category_title_1: i18next.t('1蔬菜'),
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 39.0,
      category_title_1: i18next.t('2蔬菜'),
    ...
    },
    {
      ...
      std_sale_price: 11.0,
      real_weight: 13.0,
      category_title_1: i18next.t('22蔬菜'),
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 13.0,
      category_title_1: i18next.t('12蔬菜'),
      spu_name: i18next.t('长白菜|八卦'),
      remark: '测试商品备注',
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 13.0,
      category_title_1: i18next.t('1212蔬菜'),
      spu_name: i18next.t('长白菜|八卦'),
      remark: '测试商品备注',
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 144.0,
      category_title_1: i18next.t('21蔬菜'),
      spu_name: i18next.t('长白菜'),
      remark: null,
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 39.0,
      category_title_1: i18next.t('蔬菜1'),
      spu_name: i18next.t('大白菜'),
      remark: null,
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 11.0,
      real_weight: 13.0,
      category_title_1: i18next.t('蔬菜21'),
      spu_name: i18next.t('本地|大白菜'),
      remark: '测试商品备注',
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 13.0,
      category_title_1: i18next.t('2蔬2菜1'),
      spu_name: i18next.t('长白菜|八卦'),
      remark: '测试商品备注',
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 144.0,
      category_title_1: i18next.t('蔬菜2222'),
      spu_name: i18next.t('长白菜'),
      remark: null,
      category_title_2: i18next.t('甘蓝类'),
      org_std_sale_price: 10,
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 13.0,
      category_title_1: '1大鱼大肉',
      spu_name: i18next.t('长白菜|八卦'),
      remark: '测试商品备注',
      category_title_2: i18next.t('1甘蓝类'),
      org_std_sale_price: 10,
      org_item_price: 20,
      org_sale_price: 15,
      production_time: '2019-4-17',
    ...
    },
    {
      ...
      std_sale_price: 0.0,
      real_weight: 13.0,
      category_title_1: '2大鱼大肉',
      spu_name: i18next.t('长白菜|八卦'),
      remark: '测试商品备注',
      category_title_2: i18next.t('2甘蓝类'),
      org_std_sale_price: 10,
      org_item_price: 20,
      org_sale_price: 15,
      production_time: '2019-4-17',
